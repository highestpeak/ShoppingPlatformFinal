        ...
        <div class="contact-us container-fluid no-padding">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 no-padding">
                <div class="form-detail">
                    ...
                    <form>
                        <div class="col-md-4 col-md-4 col-md-4 col-xs-12 form-group"><label>ID</label>
                            <input type="text" name="contact-name" class="form-control" id="input_ID" placeholder="ID *" required="" disabled>
                        </div>
                        <div class="col-md-4 col-md-4 col-md-4 col-xs-12 form-group"><label>用户名</label>
                            <input type="text" name="contact-email" class="form-control" id="input_name" placeholder="Full Name *" required="">
                        </div>
                        <div class="col-md-4 col-md-4 col-md-4 col-xs-12 form-group"><label>性别</label>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group"><label>密码</label>
                            <input type="text" name="contact-email" class="form-control" id="input_password" placeholder="Password *" required="">
                        </div>
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group"><label>电子邮箱</label>
                            <input type="text" name="contact-name" class="form-control" id="input_email" placeholder="Email Address *" required="">
                        </div>

                        <div class="form-group col-md-12 col-sm-12 col-xs-12">
                            <textarea placeholder="About You . . ." id="textarea_message" name="contact-message" rows="5" class="form-control"></textarea>
                        </div>
                        <div class="form-group col-md-12 col-sm-12 col-xs-12">
