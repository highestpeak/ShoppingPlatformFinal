                    ...
                    <form>
                        <table class="table table-bordered table-responsive">
                            ...
                            <tr>
                                ...
                                <th class="product-name" style="width: 30%">商品名称</th>
                                <th class="product-unit-price" style="width: 20%">单价</th>
                            ...
                            <tr>
                                <td class="action" colspan="6">
                                    <a href="index.html" title="Continue shopping">去购物</a>
                                    <a href="front_history.jsp" title="update shopping cart">刷新</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
